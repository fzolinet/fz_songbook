...
echo "\n\n\n";
echo "*******************************\n";
echo "* Make FZ Songbook installer\n";
echo "*******************************\n";
echo "\n=> Bootloader Drupal 7\n";
...
system ( 'cmd /c C:\\DOS\\tar\\bsdtar -cf E:\\' . $mdlgz . ' -z ' . TARGET );

print "=> Make E:\\" . MODULE . "-$fver.zip\n";
system ( 'cmd /c C:\\DOS\\zip\\zip -r -9 -q E:\\' . $mdlzip . ' ' . TARGET );
...
system ( 'cmd /c C:\\DOS\\zip\\zip -r -9 -q ' . $dest . MODULE . ' .' );
print "=> Copy files => ftp://www.fzolee.hu/web/download/" . MODULE . "/ \n";

// set up basic connection
$conn_id = ftp_connect ( "ulluriaq.shirokuma.hu" );
...
if ($login_result) {
  ...
  echo "=> Can not connect to FTP site\n";
}
